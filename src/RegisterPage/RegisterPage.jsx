      ...
      <div className="col-md-6 col-md-offset-3">
        ...
        <form name="form" onSubmit={this.handleSubmit}>
          ...
          <div className={'form-group'}>
            ...
            <select className={"form-control" + (submitted && !user.role ? " has-error" : "")} onChange={this.handleChange} name="role" id="role">
              <option value="">select</option>
              <option value="user">user</option>
              <option value="auditor">Auditor</option>
            </select>
            {submitted && !user.role && (
                <div className="help-block" style={{color: "#a94442"}}>Role is required</div>
            )}
          </div>
